...
export default function H1() {
    return (
        <div className={Style.Main}>
            ...
            <p>Atualmente sou estudante de Engenharia de Computação pela Universidade Federal do Vale do São Francisco UNIVASF, novo no mundo de desenvolvimento, procurando sempre aprender novas tecnologias e fundamentar melhor meus conhecimentos.</p>
